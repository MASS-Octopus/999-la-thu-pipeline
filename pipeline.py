...
def generate_tts_with_timestamps(text, outpath):
    ...
    payload = json.dumps({"text": text, "model_id": ELEVENLABS_MODEL, "voice_settings": {"stability": 0.2, "similarity_boost": 0.7, "style": 0.9, "speed": 1.2, "use_speaker_boost": True}}).encode()
